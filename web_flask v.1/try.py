...
test_variant = pd.read_csv("C:/Users/lenovo/Desktop/EC601/Project/data/stage2_test_variants.csv")
...
test_text = pd.read_csv("C:/Users/lenovo/Desktop/EC601/Project/data/stage2_test_text.csv", sep="\|\|", engine='python', header=None, skiprows=1, names=["ID","Text"])
